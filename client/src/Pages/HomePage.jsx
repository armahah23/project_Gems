           ...
           <nav className="nav-menu">  
             <div className="nav-links">
              ...
              <a href="#">SERVICES</a>
               <a href="#">OFFERS</a>
               <a href="#">STORE</a>
               <button className="sign-up-btn" onClick={handlesignupObtion}>SIGN UP</button>
             </div>
           </nav>
        </div>
       </header>
           ...
           <div className="hero-content">
            <h1>
             ...
             <div className="hero-actions">
              <button className="sign-up-btn" onClick={handlesignupObtion}>SIGN UP</button>
               <p className="login-text"> or <a href="#" onClick={navigatelogin}>CLICK HERE</a> to Log in</p>
