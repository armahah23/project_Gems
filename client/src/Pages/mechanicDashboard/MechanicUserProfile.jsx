...
const MechanicUserProfile = () => {
  ...
  //           `${API_BASE_URL}/api/getUserDetail/mechanic/${mechanicId}`
  //         );
  ...
  //   const mechanicId = localStorage.getItem('mechanicId');
  //   try {
  //     await axios.put(`${API_BASE_URL}/api/mechanics/${mechanicId}`, formData);
  //   } catch (error) {
  ...
  //     if (mechanicId) {
  //       try {
  //         const response = await axios.get(`${API_BASE_URL}/api/mechanics/${mechanicId}`);
  //         const mechanic = response.data;
  //         setFormData({
  //           name: mechanic.name,
  //           email: mechanic.email,
