  ...
  const StarRating = ({ rating, light = false }) => {
    return (
      <div className="flex items-center">
        ...
        <span
          className={`ml-1 text-sm ${light ? "text-white" : "text-gray-600"}`}
        >
          {rating.toFixed(1)}
        </span>
      </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="font-medium">
                    {getFixedRandomExperience(mechanic._id)} years
                  </p>
                </div>
                <div>
                  <p className="text-sm text-white/80">Rating</p>
                  <StarRating
                    rating={getFixedRandomRating(mechanic._id)}
                    light={true}
                  />
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <StarRating
                      rating={getFixedRandomRating(selectedMechanic._id)}
                    />
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg">
